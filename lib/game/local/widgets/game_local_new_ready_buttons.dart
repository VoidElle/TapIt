...
class GameLocalNewReadyButtons extends ConsumerStatefulWidget {

  const GameLocalNewReadyButtons({super.key});

  @override
  ConsumerState<GameLocalNewReadyButtons> createState() => _GameLocalNewReadyButtonsState();
}

class _GameLocalNewReadyButtonsState extends ConsumerState<GameLocalNewReadyButtons> {
